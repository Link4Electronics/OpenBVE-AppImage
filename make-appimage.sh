...
# Deploy dependencies
quick-sharun /usr/bin/openbve /usr/bin/mono /usr/lib/openbve/OpenBve.exe /usr/lib/openbve /usr/share/games/openbve /usr/lib/libmono*.so* #/usr/lib/mono/4.0* /usr/lib/mono/4.5* 
